		...
		<>
			<section className="bg-white dark:bg-gray-900">
				<div className="container px-6 py-10 mx-auto">
					...
					<p className="max-w-2xl text-sm mx-auto my-2 lg:my-6 text-center text-gray-500 dark:text-gray-300">
					...
					<div className="flex overflow-x-scroll gap-2 md:p-4  lg:gap-8 lg:mt-8 ">
						<div className="flex flex-col shrink-0 border  items-center p-8 transition-colors duration-300 transform cursor-pointer group  rounded-xl">
							<img
